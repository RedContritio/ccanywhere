...
- nginx + `scripts/cert-issue.sh`(DNS-01,适合 443 不能直连场景),
  详细见 `docs/deployment-frpc.md`(原 frp 拓扑下的 cert 申请流程也通用)
- frp tunnel(mac 在 NAT 后,见 `docs/deployment-frpc.md` + `examples/frpc.toml`)
