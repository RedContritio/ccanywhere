...
// real cc binary. Two prod bugs slipped past sh-fixture integration
// tests because sh-on-bad-flags happens to exit similarly to
// cc-panic-then-exit — this helper exists so the regression guards stay
// sharp.
